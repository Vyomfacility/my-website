<?php
/* Start Section */
add_action('elementor/element/section/section_structure/after_section_end', 'herrington_add_custom_section_controls');
// add_action( 'elementor/element/section/section_structure/after_section_end', 'herrington_add_custom_section_overlay_color' ); 
// add_action( 'elementor/element/section/section_structure/after_section_end', 'herrington_add_custom_section_overlay_img' ); 
// add_action( 'elementor/element/section/section_structure/after_section_end', 'herrington_add_custom_section_divider' ); 
// add_action( 'elementor/element/section/section_structure/after_section_end', 'herrington_add_custom_section_particles' );
// add_action( 'elementor/element/section/section_structure/after_section_end', 'herrington_add_custom_section_effect_image' );
function herrington_add_custom_section_controls(\Elementor\Element_Base $element)
{

    $element->start_controls_section(
        'section_pxl',
        [
            'label' => esc_html__('Herrington General Settings', 'herrington'),
    ...
    if (get_post_type(get_the_ID()) === 'pxl-template' && get_post_meta(get_the_ID(), 'template_type', true) === 'header-mobile') {
        ...
        $element->add_control(
            'pxl_header_type',
            [
                'label' => esc_html__('Header Type', 'herrington'),
                'type'  => \Elementor\Controls_Manager::SELECT,
                'hide_in_inner' => true,
                'options'      => array(
                    ''          => esc_html__('Select Type', 'herrington'),
                    'sticky'      => esc_html__('Header Sticky', 'herrington'),
                ),
                'default'      => '',
            ]
        );
    ...
    $element->add_control(
        'row_scroll_fixed',
        [
            'label'   => esc_html__('Column Fixed', 'herrington'),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__('No', 'herrington'),
                'fixed'   => esc_html__('Yes', 'herrington'),
            ),
    ...
    $element->add_control(
        'row_zoom_point',
        [
            'label'   => esc_html__('Zoom Point', 'herrington'),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'description' => 'Background color displayed on scroll.',
            'options' => array(
                'false'        => esc_html__('No', 'herrington'),
                'true'   => esc_html__('Yes', 'herrington'),
            ),
            'default'      => 'false',
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Zoom Point - Color', 'herrington'),
    ...
    $element->add_control(
        'row_zoom_point_img',
        [
            'label' => esc_html__('Zoom Point - Image', 'herrington'),
    ...
    $element->add_control(
        ...
        [
            ...
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'visible'        => esc_html__('Visible', 'herrington'),
                'hidden'   => esc_html__('Hidden', 'herrington'),
            ),
            'default'      => 'visible',
            'separator' => 'after',
    ...
    $element->add_control(
        'pxl_parallax_bg_img',
        [
            'label' => esc_html__('Parallax Background Image', 'herrington'),
            'type' => \Elementor\Controls_Manager::MEDIA,
            'hide_in_inner' => true,
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Background Position', 'herrington'),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('X Position', 'herrington'),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Y Position', 'herrington'),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'hide_in_inner' => true,
            'size_units' => ['px', 'em', '%', 'vw'],
            'default' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Background Size', 'herrington'),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__('Default', 'herrington'),
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Parallax Background Position', 'herrington'),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__('Default', 'herrington'),
            'label_on' => esc_html__('Custom', 'herrington'),
            'return_value' => 'yes',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
            ]
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Left', 'herrington') . ' (50px) px,%,vw,auto',
            'type' => 'text',
            'default' => '',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Top', 'herrington') . ' (50px) px,%,vw,auto',
            'type' => 'text',
            'default' => '',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Right', 'herrington') . ' (50px) px,%,vw,auto',
            'type' => 'text',
            'default' => '',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Bottom', 'herrington') . ' (50px) px,%,vw,auto',
            'type' => 'text',
            'default' => '',
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Parallax Background Effect', 'herrington'),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__('Default', 'herrington'),
            'label_on' => esc_html__('Custom', 'herrington'),
            'return_value' => 'yes',
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('TranslateX', 'herrington') . ' (-80)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('TranslateY', 'herrington') . ' (-80)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('TranslateZ', 'herrington') . ' (-80)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Rotate X', 'herrington') . ' (30)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Rotate Y', 'herrington') . ' (30)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Rotate Z', 'herrington') . ' (30)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Scale X', 'herrington') . ' (1.2)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Scale Y', 'herrington') . ' (1.2)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Scale Z', 'herrington') . ' (1.2)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Scale', 'herrington') . ' (1.2)',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Scroll From (px)', 'herrington') . ' (350) from offset top',
            'type' => 'text',
            'default' => '',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__('Parallax Opacity (0 - 100)', 'herrington'),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => ['%'],
            'range' => [
                '%' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Full Content with space from?', 'herrington'),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'prefix_class' => 'pxl-full-content-with-space-',
            'options'      => array(
                'none'    => esc_html__('None', 'herrington'),
                'start'   => esc_html__('Start', 'herrington'),
                'end'     => esc_html__('End', 'herrington'),
            ),
            'default'      => 'none',
            'condition' => [
                'layout' => 'full_width'
    ...
    $element->add_control(
        'pxl_container_width',
        [
            'label' => esc_html__('Container Width', 'herrington'),
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Parallax Background Image Style 2', 'herrington'),
            'type' => \Elementor\Controls_Manager::MEDIA,
            'hide_in_inner' => true,
            'selectors' => [
                '{{WRAPPER}} .pxl-section-bg-parallax' => 'background-image: url( {{URL}} );',
...
add_filter('pxl_section_start_render', 'herrington_custom_section_start_render', 10, 3);
function herrington_custom_section_start_render($html, $settings, $el)
{
...
// function herrington_add_custom_section_overlay_color( \Elementor\Element_Base $element) {

//     $element->start_controls_section(
//         'section_overlay_color',
//         [
//             'label' => esc_html__( 'Herrington Overlay Color', 'herrington' ),
//             'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
//         ]
//     );
...
//             'options' => array(
//                 'none'        => esc_html__( 'No', 'herrington' ),
//                 'full'   => esc_html__( 'Full', 'herrington' ),
//                 'skew'   => esc_html__( 'Skew', 'herrington' ),
//                 'scroll'   => esc_html__( 'Scroll', 'herrington' ),
//             ),
...
//         'overlay_left_space',
//         [
//             'label' => esc_html__('Overlay Left Space', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
...
//         'overlay_right_space',
//         [
//             'label' => esc_html__('Overlay Right Space', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'control_type' => 'responsive',
//             'size_units' => [ 'px' ],
//             'range' => [
...
//         [
//             'label' => esc_html__('Overlay Border Radius', 'herrington' ),
...
//         'overlay_space_sc',
//         [
//             'label' => esc_html__('Overlay Space', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::DIMENSIONS,
//             'control_type' => 'responsive',
//             'condition' => [
...
// function herrington_add_custom_section_overlay_img( \Elementor\Element_Base $element) {

//     $element->start_controls_section(
//         'section_overlay_img',
//         [
//             'label' => esc_html__( 'Herrington Overlay Image', 'herrington' ),
//             'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
//         ]
//     );
...
//         'pxl_overlay_display',
//         [
//             'label'   => esc_html__( 'Overlay Image', 'herrington' ),
//             'type'    => \Elementor\Controls_Manager::SELECT,
//             'options' => array(
//                 'none'        => esc_html__( 'No', 'herrington' ),
//                 'image'   => esc_html__( 'Yes', 'herrington' ),
//             ),
...
//         'pxl_overlay_img',
//         [
//             'label'   => esc_html__( 'Select Image 1', 'herrington' ),
//             'type'    => \Elementor\Controls_Manager::MEDIA,
//             'condition' => [
...
//         [
//             'label' => esc_html__( 'Background Position - Image 1', 'herrington' ),
//             'type'         => \Elementor\Controls_Manager::SELECT,
//             'hide_in_inner' => true,
//             'options'      => array(
//                 ''              => esc_html__( 'Default', 'herrington' ),
...
//         [
//             'label' => esc_html__('Border Radius - Image 1', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::DIMENSIONS,
//             'control_type' => 'responsive',
//             'selectors' => [
...
//         [
//             'label' => esc_html__('Margin - Image 1', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::DIMENSIONS,
//             'control_type' => 'responsive',
//             'selectors' => [
...
//         [
//             'label' => esc_html__('Width Image 1', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'control_type' => 'responsive',
//             'size_units' => [ '%', 'px' ],
//             'range' => [
...
//         'pxl_overlay_img2',
//         [
//             'label'   => esc_html__( 'Select Image 2', 'herrington' ),
//             'type'    => \Elementor\Controls_Manager::MEDIA,
//             'condition' => [
//                 'pxl_overlay_display' => ['image'],
//             ],
...
//         [
//             'label' => esc_html__( 'Background Position - Image 2', 'herrington' ),
//             'type'         => \Elementor\Controls_Manager::SELECT,
//             'hide_in_inner' => true,
//             'options'      => array(
//                 ''              => esc_html__( 'Default', 'herrington' ),
...
//         [
//             'label' => esc_html__('Border Radius - Image 2', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::DIMENSIONS,
//             'control_type' => 'responsive',
//             'selectors' => [
...
//         [
//             'label' => esc_html__('Margin - Image 2', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::DIMENSIONS,
//             'control_type' => 'responsive',
//             'selectors' => [
...
//         [
//             'label' => esc_html__('Width Image 2', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'control_type' => 'responsive',
//             'size_units' => [ '%', 'px' ],
//             'range' => [
...
//         [
//             'label' => esc_html__('Offset Left - Image 2', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'control_type' => 'responsive',
//             'size_units' => [ 'px' ],
//             'range' => [
...
// function herrington_add_custom_section_divider( \Elementor\Element_Base $element) {

//     $element->start_controls_section(
//         'section_divider',
//         [
//             'label' => esc_html__( 'Herrington Divider', 'herrington' ),
//             'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
//         ]
//     );
...
//         'row_divider',
//         [
//             'label'   => esc_html__( 'Divider', 'herrington' ),
//             'type'    => \Elementor\Controls_Manager::SELECT,
//             'options' => array(
//                 ''        => esc_html__( 'None', 'herrington' ),
//                 'rounded-top'   => esc_html__( 'Rounded Top', 'herrington' ),
//                 'angle-top'   => esc_html__( 'Angle Top Left', 'herrington' ),
//                 'angle-top-right'   => esc_html__( 'Angle Top Right', 'herrington' ),
//                 'angle-bottom-left'   => esc_html__( 'Angle Bottom Left', 'herrington' ),
//                 'angle-bottom'   => esc_html__( 'Angle Bottom Right', 'herrington' ),
//                 'angle-top-bottom'   => esc_html__( 'Angle Top & Bottom Right', 'herrington' ),
//                 'angle-top-bottom-left'   => esc_html__( 'Angle Top & Bottom Left', 'herrington' ),
//                 'wave-animation-top'   => esc_html__( 'Wave Animation Top', 'herrington' ),
//                 'wave-animation-bottom'   => esc_html__( 'Wave Animation Bottom 1', 'herrington' ),
//                 'wave-animation-bottom2'   => esc_html__( 'Wave Animation Bottom 2', 'herrington' ),
//                 'curved-top'   => esc_html__( 'Curved Top', 'herrington' ),
//                 'curved-bottom'   => esc_html__( 'Curved Bottom', 'herrington' ),
//                 'vertical1'   => esc_html__( 'Divider Vertical', 'herrington' ),
//                 'curved-arrow'   => esc_html__( 'Curved Arrow', 'herrington' ),
//                 'curved-arrow-inner-top'   => esc_html__( 'Curved Arrow Inner Top', 'herrington' ),
//                 'curved-arrow-inner-bottom'   => esc_html__( 'Curved Arrow Inner Bottom', 'herrington' ),
//                 'divider-border'   => esc_html__( 'Divider Broder Top/Bottom', 'herrington' ),
//             ),
...
//         'divider_height',
//         [
//             'label' => esc_html__('Divider Height', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'control_type' => 'responsive',
//             'size_units' => [ 'px' ],
//             'range' => [
...
// function herrington_add_custom_section_particles( \Elementor\Element_Base $element) {

//     $element->start_controls_section(
//         'section_particles',
//         [
//             'label' => esc_html__( 'Herrington Particles', 'herrington' ),
//             'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
//         ]
//     );
...
//         [
//             'label'   => esc_html__( 'Particles', 'herrington' ),
...
//         'size_random',
//         [
//                 'label' => esc_html__('Size Random', 'herrington'),
//                 'type' => \Elementor\Controls_Manager::SWITCHER,
//                 'default' => 'false',
//                 'condition' => [
//                     'row_particles_display' => ['yes'],
...
//         'move_direction',
//         [
//             'label'   => esc_html__( 'Move Direction', 'herrington' ),
//             'type'    => \Elementor\Controls_Manager::SELECT,
//             'options' => array(
//                 'none'        => esc_html__( 'None', 'herrington' ),
...
//                 'bottom-right'        => esc_html__( 'Bottom Right', 'herrington' ),
//                 'bottom'        => esc_html__( 'Bottom', 'herrington' ),
//                 'bottom-left'        => esc_html__( 'Bottom Left', 'herrington' ),
...
// function herrington_add_custom_section_effect_image( \Elementor\Element_Base $element) {

//     $element->start_controls_section(
//         'section_effect_image',
//         [
//             'label' => esc_html__( 'Herrington Effect Images', 'herrington' ),
//             'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
//         ]
//     );
...
//         'image_position', 
//         [
//             'label' => esc_html__('Image Position', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SELECT,
//             'options' => [
//                 'p-top-left' => 'Top Left',
...
//         'image_position_top', 
//         [
//             'label' => esc_html__('Top Position', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'size_units' => [ 'px', '%' ],
//             'control_type' => 'responsive',
//             'default' => [
...
//         'image_position_left', 
//         [
//             'label' => esc_html__('Left Position', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'size_units' => [ 'px', '%' ],
//             'control_type' => 'responsive',
//             'default' => [
...
//         [
//             'label' => esc_html__('Bottom Position', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'size_units' => [ 'px', '%' ],
//             'control_type' => 'responsive',
//             'default' => [
...
//         [
//             'label' => esc_html__('Right Position', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::SLIDER,
//             'size_units' => [ 'px', '%' ],
//             'control_type' => 'responsive',
//             'default' => [
...
//         [
//             'label' => esc_html__('Parallax Scroll Value', 'herrington' ),
...
//         [
//             'label' => esc_html__('Parallax Hover Value', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::TEXT,
//             'default' => '40',
//             'description' => esc_html__('Enter number.', 'herrington' ),
//             'condition' => [
...
//         'image_display_md', 
//         [
//             'label' => esc_html__('Hide on Screen <= 1200px', 'herrington'),
//             'type' => \Elementor\Controls_Manager::SWITCHER,
//             'default' => 'false',
//         ]
//     );
...
//         'image_display_sm', 
//         [
//             'label' => esc_html__('Hide on Screen <= 767px', 'herrington'),
//             'type' => \Elementor\Controls_Manager::SWITCHER,
//             'default' => 'false',
//         ]
//     );
...
//         'row_effect_images',
//         [
//             'label'   => esc_html__( 'Images', 'herrington' ),
//             'type' => \Elementor\Controls_Manager::REPEATER,
...
/* Start Column */
add_action('elementor/element/column/layout/after_section_end', 'herrington_add_custom_columns_controls');
function herrington_add_custom_columns_controls(\Elementor\Element_Base $element)
{
    $element->start_controls_section(
        'columns_pxl',
        [
    ...
    $element->add_control(
        'col_content_align',
        [
            'label'   => esc_html__('Column Content Align', 'herrington'),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''           => esc_html__('Default', 'herrington'),
                'start'           => esc_html__('Start', 'herrington'),
                'center'           => esc_html__('Center', 'herrington'),
                'end'           => esc_html__('End', 'herrington'),
            ),
            'default' => '',
    ...
    $element->add_control(
        'col_sticky',
        [
            'label'   => esc_html__('Column Sticky', 'herrington'),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'           => esc_html__('No', 'herrington'),
                'sticky' => esc_html__('Yes', 'herrington'),
            ),
            'default' => 'none',
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Sticky Offset Top', 'herrington'),
            'type' => 'text',
            'description' => esc_html__('Enter number.', 'herrington'),
            'default'  => '30',
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overflow Hidden', 'herrington'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'herrington'),
            'label_off' => esc_html__('No', 'herrington'),
            'return_value' => 'yes',
            'default' => 'no',
    ...
    $element->add_control(
        'pxl_column_line',
        [
            'label' => esc_html__('Line', 'herrington'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'herrington'),
            'label_off' => esc_html__('No', 'herrington'),
            'return_value' => 'yes',
            'default' => 'no',
            'prefix_class' => 'pxl-column-line-'
        ]
    );
...
add_action('elementor/element/after_add_attributes', 'herrington_custom_el_attributes', 10, 1);
function herrington_custom_el_attributes($el)
{
...
add_filter('pxl-custom-section/before-render', 'herrington_custom_section_before_render', 10, 3);
function herrington_custom_section_before_render($html, $settings, $el)
{
...
add_filter('pxl-custom-column/before-render', 'herrington_custom_column_before_render', 10, 3);
function herrington_custom_column_before_render($html, $settings, $el)
{
