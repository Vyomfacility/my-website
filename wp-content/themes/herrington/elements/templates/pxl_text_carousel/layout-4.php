...
if(isset($settings['text4']) && !empty($settings['text4']) && count($settings['text4'])): ?>
    <div class="pxl-swiper-slider pxl-text-carousel pxl-text-carousel4 <?php echo esc_attr($settings['style']); ?>" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'herrington'); ?>"<?php endif; ?>>
            ...
            <div class="pxl-swiper-bottom pxl-flex-middle">
                ...
                <?php if($arrows !== false): ?>
                    <div class="pxl-wrap-arrow pxl-flex-middle">
                        <div class="pxl-swiper-arrow pxl-swiper-arrow-prev"><i class="bootstrap-icons bi-arrow-left rtl-icon"></i></div>
                        <div class="pxl-swiper-arrow pxl-swiper-arrow-next"><i class="bootstrap-icons bi-arrow-right rtl-icon"></i></div>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
