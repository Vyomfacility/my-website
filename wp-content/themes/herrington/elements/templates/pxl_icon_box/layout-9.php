<div class="pxl-icon-box pxl-icon-box9 <?php echo esc_attr($settings['style'].' '.$settings['animate_hover'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner front">
    ...
    <div class="pxl-item--inner behind">
        <<?php echo esc_attr($settings['title_tag']); ?> class="pxl-item--title el-empty">
        ...
        <a class="btn-link" <?php pxl_print_html($widget->get_render_attribute_string('item_link')); ?> >
