 <?php
    ...
    if (isset($settings['icons']) && !empty($settings['icons']) && count($settings['icons'])): ?>
     <div id="pxl-gallery-<?php echo esc_attr($pxl_g_id); ?>" class="pxl-swiper-slider pxl-icons-carousel pxl-icons-carousel1" <?php if ($drap !== false) : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'herrington'); ?>" <?php endif; ?>>
