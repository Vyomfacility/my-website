...
extract(pxl_get_posts_of_grid('industries', [
    'source' => $source,
    'orderby' => $orderby,
    'order' => $order,
    'limit' => $limit,
...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-industries-carousel pxl-industries-carousel1 pxl-industries-style1 ">
        ...
        <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
            <div class="pxl-swiper-wrapper">
                ...
                foreach ($posts as $post):
                    ...
                    ?>
                    <div class="pxl-swiper-slide" data-filter="<?php echo esc_attr($filter_class); ?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('Drag.', 'herrington'); ?>"<?php endif; ?>>
                        <div class="pxl-post--inner <?php echo esc_attr($pxl_animate); ?> wow" style="background-image:url(<?php echo esc_url($thumbnail_url); ?>);">
                            <div class="pxl-post--holder">
                                <div class="pxl-meta-top">
                                    <?php if($show_category == 'true'): ?>
                                        <div class="pxl-post--category">
                                            <?php the_terms( $post->ID, 'industries-category', '', ', ' ); ?>
                                        </div>
                                    <?php endif; ?>
