...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-post-carousel pxl-post-carousel1 pxl-post-style1 " <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'herrington'); ?>"<?php endif; ?>>
                                    ...
                                    <div class="pxl-item-top">
                                        ...
                                        <?php if ($show_author == 'true'): ?>
                                            <span class="post-author align-items-center">
                                                ...
                                                <span><?php echo esc_html__('By', 'herrington'); ?>&nbsp;<?php echo pxl_print_html($author_name); ?></span>
                                            </span>
                                        <?php endif ?>
                                        ...
                                        <?php if ($show_comment == 'true'): ?>
                                            <span class="post-comments  align-items-center">
                                                ...
                                                <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                                    <span><?php comments_number(esc_html__('No Comment', 'herrington'), esc_html__(' 1 Comment', 'herrington'), esc_html__('%'.' Comments', 'herrington'),$post->ID); ?></span>
                                                </a>
                                            </span>
                                        <?php endif ?>
                                    </div>
