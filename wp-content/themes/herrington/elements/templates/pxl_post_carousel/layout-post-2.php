...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-post-carousel pxl-post-carousel2 <?php echo pxl_print_html($settings['style_l11'])?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'herrington'); ?>"<?php endif; ?>>
                        ...
                        <div class="pxl-swiper-slide">
                            ...
                            <div class="pxl-post--meta pxl-flex-middle">
                                ...
                                <div class="pxl-post--category">
                                    _ <?php the_terms( $post->ID, 'category', '', ' ' ); ?>
                                </div>
                                <?php endif ?>
                            </div>
