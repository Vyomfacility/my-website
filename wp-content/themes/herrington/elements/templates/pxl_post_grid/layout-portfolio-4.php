...
$wrap_attrs = [
    'id'               => $html_id,
    'class'            => trim('pxl-grid pxl-portfolio-grid pxl-portfolio-grid-layout4 pxl-portfolio-style4'),
    ...
    <?php if (!empty($next_link) && $pagination_type == 'loadmore') { ?>
        <div class="pxl-load-more">
            <span class="btn-grid-loadmore btn-submit">
                <span class="pxl-loadmore-text"><?php echo esc_html__('Load More', 'herrington') ?></span>
