...
if(isset($settings['slider1']) && !empty($settings['slider1']) && count($settings['slider1'])): ?>
    <div class="pxl-swiper-slider pxl-slider-carousel pxl-slider-carousel2 pxl-drag-area pxl-parent-transition pxl-parent-cursor pxl-swiper-arrow-show <?php if($arrows == 'true') { echo esc_attr__( 'pxl-show-arrow', 'herrington' ); } ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>">
                                                        ...
                                                        <a class="item--button btn-1 wow fadeInUp" data-wow-delay="1900ms" <?php echo implode( ' ', [ $link_attributes ] ); ?>>
                                                            <span class="btn-text">
                                                                <?php if(!empty($btn_text)) {
                                                                    ...
                                                                    echo esc_html__('VIEW DETAILS', 'herrington');
                                                                } ?>
                                                            </span>
