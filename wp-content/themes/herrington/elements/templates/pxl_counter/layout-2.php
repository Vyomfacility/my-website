...
<div class="pxl-counter pxl-counter2 <?php echo esc_attr($settings['pxl_animate']); ?> <?php echo esc_attr($settings['style_l2']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
