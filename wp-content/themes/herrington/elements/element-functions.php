 ...
 * Swipper Lib
*/
if(!function_exists('herrington_elements_scripts')){
    add_action( 'wp_enqueue_scripts', 'herrington_elements_scripts');
    function herrington_elements_scripts() {  
        ...
        wp_enqueue_script('herrington-countdown', get_template_directory_uri() . '/elements/widgets/js/pxl-countdown.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        
        wp_register_script('herrington-particle', get_template_directory_uri() . '/elements/widgets/js/particle.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('herrington-parallax', get_template_directory_uri() . '/elements/widgets/js/parallax.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        ...
        wp_register_script('herrington-counter', get_template_directory_uri() . '/elements/widgets/js/counter.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('herrington-accordion', get_template_directory_uri() . '/elements/widgets/js/accordion.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('herrington-tabs', get_template_directory_uri() . '/elements/widgets/js/tabs.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('herrington-progressbar', get_template_directory_uri() . '/elements/widgets/js/progressbar.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('herrington-countdown', get_template_directory_uri() . '/elements/widgets/js/countdown.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        ...
        wp_register_script('herrington-pie-chart', get_template_directory_uri() . '/elements/widgets/js/pie-chart.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_enqueue_script('herrington-elementor', get_template_directory_uri() . '/elements/widgets/js/elementor.js', [ 'jquery' ], $theme->get( 'Version' ), true);
    }
}
...
*/
if(!function_exists('herrington_register_custom_icon_library')){
    add_filter('elementor/icons_manager/native', 'herrington_register_custom_icon_library');
    function herrington_register_custom_icon_library($tabs){
        $custom_tabs = [
            'pxl_icon1' => [
                'name' => 'flaticon',
                'label' => esc_html__( 'Herrington', 'herrington' ),
                'url' => false,
                'enqueue' => false,
                'prefix' => 'flaticon-',
            ...
            'pxl_bootstrap_icons' => [
                ...
                'label' => esc_html__( 'Bootstrap Icons', 'herrington' ),
                'url' => false,
                'enqueue' => false,
                'prefix' => 'bi-',
...
*/
if(!function_exists('herrington_get_class_widget_path')){
    function herrington_get_class_widget_path(){
...
*/
function herrington_get_post_type_options($pt_supports=[]){
...
*/
function herrington_get_post_grid_layout($pt_supports = []){
    $post_types  = herrington_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            'name'     => 'layout_'.$name,
            'label'    => sprintf(esc_html__( 'Select Template of %s', 'herrington' ), $label),
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => herrington_get_grid_layout_options($name),
...
function herrington_get_grid_layout_options($posttype_name){
    $option_layouts = [];
...
function herrington_get_term_by_posttype($pt_supports = [], $args = []){
    ...
    foreach ($post_types as $name => $label) {
        ...
        $result[] = array(
            'name' => 'source_' . $name,
            'label' => sprintf(esc_html__('Select Term', 'herrington'), $label),
            'description' => esc_html__('Get all when no term selected', 'herrington'),
...
function herrington_get_grid_term_by_posttype($pt_supports = [], $args=[]){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]); 
    $post_types  = herrington_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
    ...
    foreach ($post_types as $name => $label) {
        ...
        $result[] = array(
            'name'     => 'source_'.$name,
            'label'    => sprintf(esc_html__( 'Select Term of %s', 'herrington' ), $label),
            'type'     => \Elementor\Controls_Manager::SELECT2,
            'multiple' => true,
            'options'  => pxl_get_grid_term_options($name,$taxonomy),
            'condition' => array_merge(
...
function herrington_get_ids_by_posttype($pt_supports = [], $args = []){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types = herrington_get_post_type_options($pt_supports);
    $result = [];
    if (!is_array($post_types))
    ...
    foreach ($post_types as $name => $label) {
        ...
        $posts = herrington_list_post($name, false);

        $result[] = array(
            'name' => 'source_' . $name . '_post_ids',
            'label' => sprintf(esc_html__('Select posts', 'herrington'), $label),
            'type' => \Elementor\Controls_Manager::SELECT2,
            'multiple' => true,
            'options' => $posts,
            'label_block' => true,
...
function herrington_get_ids_unselected_by_posttype($pt_supports = [], $args = []){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types = herrington_get_post_type_options($pt_supports);
    $result = [];
    if (!is_array($post_types))
    ...
    foreach ($post_types as $name => $label) {
        ...
        $result[] = array(
            ...
            'label' => sprintf(esc_html__('Unselected posts', 'herrington'), $label),
            'type' => \Elementor\Controls_Manager::SELECT2,
            'multiple' => true,
            'options' => $posts,
            'label_block' => true,
...
function herrington_get_grid_ids_by_posttype($pt_supports = [], $args = []){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types = herrington_get_post_type_options($pt_supports);
    $result = [];
    if (!is_array($post_types))
...
*/
function herrington_get_post_carousel_layout($pt_supports = []){
    $post_types  = herrington_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => herrington_get_carousel_layout_options($name),
...
function herrington_get_carousel_layout_options($posttype_name){
    $option_layouts = [];
    switch ($posttype_name) {
        case 'portfolio':
        $option_layouts = [
        ...
        $option_layouts = [
            ...
            'service-6' => [
                ...
                'image' => get_template_directory_uri() . '/elements/widgets/img-layout/pxl_post_carousel/service-layout6.jpg'
            ],
        ];
        break;
        ...
        $option_layouts = [
            'industries-1' => [
                'label' => esc_html__( 'Layout 1', 'herrington' ),
                'image' => get_template_directory_uri() . '/elements/widgets/img-layout/pxl_post_carousel/industries-layout1.jpg'
            ],
        ];
        break;
    }
...
*/
function herrington_get_post_list_layout($pt_supports = []){
    $post_types  = herrington_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => herrington_get_list_layout_options($name),
            'prefix_class' => 'post-layout-',
            'condition' => [
                'post_type' => [$name]
            ]
...
function herrington_get_list_layout_options($posttype_name){
    $option_layouts = [];
    switch ($posttype_name) {
        case 'post':
        $option_layouts = [
...
function herrington_get_carousel_term_by_posttype($pt_supports = [], $args=[]){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types  = herrington_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
...
*/
function herrington_get_post_modern_layout($pt_supports = []){
    $post_types  = herrington_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => herrington_get_modern_layout_options($name),
            'prefix_class' => 'post-layout-',
            'condition' => [
                'post_type' => [$name]
            ]
...
function herrington_get_modern_layout_options($posttype_name){
    $option_layouts = [];
    switch ($posttype_name) {
...
*/
function herrington_get_post_slip_layout($pt_supports = []){
    $post_types  = herrington_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'portfolio-1',
            'options'  => herrington_get_slip_layout_options($name),
...
function herrington_get_slip_layout_options($posttype_name){
    $option_layouts = [];
    switch ($posttype_name) {
...
/* Icon render */ 
function herrington_elementor_icon_render( $settings, $args = []){
...
function herrington_widget_animate() {
    $herrington_animate = array(
        '' => 'None',
        'wow bounce' => 'bounce',
        'wow flash' => 'flash',
        'wow pulse' => 'pulse',
    ...
    return $herrington_animate;
}

function herrington_widget_animate_v2() {
    $herrington_animate_v2 = array(
        '' => 'None',
        'wow bounce' => 'bounce',
        'wow flash' => 'flash',
        'wow pulse' => 'pulse',
 ...
 * Pagram Animation
*/
if(!function_exists('herrington_widget_animation_settings')){
    function herrington_widget_animation_settings($args = []){
        $args = wp_parse_args($args, [
            ...
            'controls'  => array_merge(
                array(
                    ...
                    array(
                        ...
                        'label' => esc_html__('Animate Delay', 'herrington' ),
...
if(!function_exists('herrington_widget_color_type')){
    function herrington_widget_color_type($args = []){
        ...
        $options = array(
            array(
                ...
                'label' => esc_html__('Color Type', 'herrington' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'normal' => 'Normal',
                    'gradient' => 'Gradient',
            ...
            array(
                ...
                'label' => esc_html__('Normal Color', 'herrington' ),
            ...
            array(
                ...
                'label' => $args['label'] .' '.esc_html__('Gradient Color', 'herrington' ),
            ...
            array(
                ...
                'label'       => ucfirst( str_replace('_', '', $args['prefix']) ).' '. esc_html__( 'Start Popover', 'herrington' ),
                'type'        => 'pxl_start_popover',
                'condition'   => $args['condition'],
            ),
            array(
                'name' => $args['prefix'].'_gradient_color_from',
                'label' => esc_html__('From', 'herrington' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                ...
                'label' => esc_html__('To', 'herrington' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                ...
                'label'       => ucfirst( str_replace('_', '', $args['prefix']) ).' '. esc_html__( 'End Popover', 'herrington' ),
...
if(!function_exists('herrington_widget_gradient_color')){
    function herrington_widget_gradient_color($args = []){
        $gradient_prefix_class = 'pxl-';
        $gradient_return_value = 'gradient';
        $args = wp_parse_args($args, [
            'label' => '',
...
if(!function_exists('herrington_widget_gradient_color_rotate')){
    function herrington_widget_gradient_color_rotate($args = []){
        $gradient_prefix_class = 'pxl-';
        $gradient_return_value = 'gradient';
        $args = wp_parse_args($args, [
            'label' => '',
        ...
        $options = array(
            ...
            array(
                ...
                'label' => esc_html__('Angle', 'herrington' ),
...
function herrington_get_img_link_url( $settings ) {
