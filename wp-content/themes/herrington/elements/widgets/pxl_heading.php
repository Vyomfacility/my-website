...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_heading',
        'title' => esc_html__('BR Heading', 'herrington' ),
        'icon' => 'eicon-heading',
        ...
        'params' => array(
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Title Shadow', 'herrington' ),
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => herrington_widget_animate_v2(),
                            'default' => '',
                        ),
                        array(
                    ...
                    'controls' => array_merge(
                        array(
                            ...
                            array(
                                ...
                                'size_units' => [ 'px' ],
                                'selectors' => [
                                    '{{WRAPPER}} .pxl-heading .pxl-item--subtitle .pxl-item--subtext' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                                ],
                                'condition' => [
                                    'sub_title_style!' => 'px-sub-title-default',
                                ],
                    ...
                    'controls' => array_merge(
                        array(
                            ...
                            array(
                                ...
                                'label' => esc_html__('Color From', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Color To', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Text Image', 'herrington' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Text Image Position', 'herrington' ),
                                'type'         => \Elementor\Controls_Manager::SELECT,
                                'options'      => array(
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Text Image Size', 'herrington' ),
                                'type'         => \Elementor\Controls_Manager::SELECT,
                                'hide_in_inner' => true,
                                'options'      => array(
                                    ''              => esc_html__( 'Default', 'herrington' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Typewriter', 'herrington' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array_merge(
                        array(
                            array(
