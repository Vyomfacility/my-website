...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Testimonial Carousel', 'herrington'),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'testimonial',
                            'label' => esc_html__('Testimonial (Layout 2 only adds a maximum of 4 items)', 'herrington'),
                            'type' => \Elementor\Controls_Manager::REPEATER,
                            'controls' => array(
                                array(
                                    'name' => 'image',
                                    'label' => esc_html__('Avatar', 'herrington'),
                                ...
                                array(
                                    'name' => 'star',
                                    'label' => esc_html__('Star', 'herrington'),
                                    'type' => \Elementor\Controls_Manager::SELECT,
                                    'default' => '5',
                                    'options' => [
                                        '1' => esc_html__('1', 'herrington'),
                                        '2' => esc_html__('2', 'herrington'),
                                        '3' => esc_html__('3', 'herrington'),
                                        '4' => esc_html__('4', 'herrington'),
                                        '5' => esc_html__('5', 'herrington'),
                                    ],
                                ),
                                array(
                                    'name' => 'number',
                                    ...
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'description' => 'Only Apply For Layout 3',
                                ),
                                array(
                                    'name' => 'desc_number',
                                    'label' => esc_html__('Description Number', 'herrington'),
                                    'type' => \Elementor\Controls_Manager::TEXTAREA,
                                    'description' => 'Description Numbe Only Apply For Layout 3',
                                ),
                        ...
                        array(
                            'name' => 'link',
                            'label' => esc_html__('Link More', 'herrington'),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => 'df',
                            'options' => [
                                'sf' => esc_html__('Default', 'herrington'),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .pxl-testimonial-carousel svg' => 'svg: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-testimonial-carousel .meta-bottom .number' => 'color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'nummber_typography',
                            'label' => esc_html__('Typography', 'herrington'),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-testimonial-carousel .meta-bottom .number',
                        ),
                        array(
                            'name' => 'dnummber_color',
                            'label' => esc_html__('Color', 'herrington'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-testimonial-carousel .meta-bottom .des-number' => 'color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'dnummber_typography',
                            'label' => esc_html__('Typography', 'herrington'),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-testimonial-carousel .meta-bottom .des-number',
                        ),
                    ),
                ),
                array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'line_color',
                            'label' => esc_html__('Under Line Color', 'herrington'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'condition' => [
                                'layout' => '1'
                            ],
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .pxl-testimonial-carousel .pxl-item--desc:before' => 'background-color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'desc_color',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-testimonial-carousel1 .pxl-item--star svg ,{{WRAPPER}} .pxl-testimonial-carousel1 .pxl-item--star svg polygon' => 'fill: {{VALUE}} !important;',
                            ],
                        ),
                    ),
                ),
