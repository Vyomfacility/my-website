...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_circle_svg',
        'title' => esc_html__('BR Circle SVG ', 'herrington'),
        ...
        'params' => array(
            'sections' => array(
                array(
                    'name' => 'section_path',
                    'label' => esc_html__('Path Svg', 'herrington'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'path_svg_text',
                            'label' => esc_html__('Path', 'herrington'),
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-circle-svg svg circle' => 'fill: {{VALUE}} !important;',

                            ],
                        ),
                        array(
                            'name' => 'path_color',
                            'label' => esc_html__('Path Color', 'herrington'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-circle-svg svg path' => 'fill: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'bg_parallax_height',
                            'label' => esc_html__('SVG Height', 'herrington'),
                ...
                array(
                    'name' => 'section_dot1',
                    'label' => esc_html__('Dot Left', 'herrington'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'dot1_color_linear',
                            'label' => esc_html__('Dot Left Background Linear', 'herrington'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                        ),
                        array(
                            'name' => 'dot1_color_one',
                            'label' => esc_html__('Dot Left Background Color One', 'herrington'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'dot1_color_two',
                            'label' => esc_html__('Dot Left Background Color Two', 'herrington'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                ...
                array(
                    'name' => 'section_dot2',
                    'label' => esc_html__('Dot Right', 'herrington'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'dot2_color_linear',
                            'label' => esc_html__('Dot Right Background Linear', 'herrington'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                        ),
                        array(
                            'name' => 'dot2_color_one',
                            'label' => esc_html__('Dot Right Background Color One', 'herrington'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'dot2_color_two',
                            'label' => esc_html__('Dot Right Background Color Two', 'herrington'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
