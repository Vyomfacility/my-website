...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Image Carousel', 'herrington'),
            ...
            'sections' => array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'url_video',
                                    'label' => esc_html__('Url Video', 'herrington'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'label_block' => true,
                                ),
                            ),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'sub_title_3',
                                    'label' => esc_html__('SubTitle', 'herrington'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'label_block' => true,
                                ),
                                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'options' => [
                                ...
                                'bgr' => esc_html__('Background', 'herrington' ),
                            ],
                            'condition' => [
                                'layout' => ['1'],
                            ],
                        ...
                        array(
                            'name' => 'gap',
                            'label' => esc_html__('Gap', 'herrington' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'sizeb',
                            'label' => esc_html__('Size Button', 'herrington' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'sizei',
                            'label' => esc_html__('Size Icon', 'herrington' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
