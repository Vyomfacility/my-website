...
if(class_exists('WPCF7')) {
    ...
    if ($cf7) {
        ...
        $contact_forms[esc_html__('No contact forms found', 'herrington')] = 0;
    }

    pxl_add_custom_widget(
        array(
            'name' => 'pxl_contact_form',
            'title' => esc_html__('BR Contact Form', 'herrington'),
                ...
                'sections' => array(
                    array(
                        ...
                        'controls' => array(
                            array(
                                'name' => 'form_id',
                                'label' => esc_html__('Select Form', 'herrington'),
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input', 'herrington'),
                        ...
                        'controls' => array(
                            ...
                            array(
                                'name' => 'input_padding',
                                'label' => esc_html__('Padding Input', 'herrington' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Border Color Focus', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'default' => '',
                                'selectors' => [
                            ...
                            array(
                                'name' => 'input_height',
                                'label' => esc_html__('Input Height', 'herrington' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Height', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Padding Textarea', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => [ 'px' ],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Type', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::SELECT,
                                'options' => [
                                    '' => esc_html__( 'None', 'herrington' ),
                                    'solid' => esc_html__( 'Solid', 'herrington' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Width', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Typography', 'herrington' ),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                'name' => 'textarea_color',
                                'label' => esc_html__('Textarea Color', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Spacer Bottom', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input Hover', 'herrington'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                        ...
                        'controls' => array_merge(
                            array(
                                array(
                                    ...
                                    'label' => esc_html__('Button Typography', 'herrington' ),
                                    'type' => \Elementor\Group_Control_Typography::get_type(),
                                    'control_type' => 'group',
                                ...
                                array(
                                    'name' => 'button_color',
                                    'label' => esc_html__('Button Color', 'herrington' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Color Hover', 'herrington' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color', 'herrington' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color Hover', 'herrington' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                            ...
                            array(
                                ...
                                array(
                                    'name' => 'btn_spacer_top',
                                    'label' => esc_html__('Spacer Top', 'herrington' ),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'control_type' => 'responsive',
                                    'size_units' => [ 'px' ],
                                    'range' => [
                    ...
                    array(
                        'name' => 'extra',
                        'label' => esc_html__('Extra', 'herrington'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                                'name' => 'bgbcolor',
                            ...
                            array(
                                ...
                                'label' => esc_html__('Notification Color', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                'name' => 'label_color',
                                'label' => esc_html__('Label Color', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Label Typography', 'herrington' ),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                ...
                                'label' => esc_html__('Label Spacer Bottom', 'herrington' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Radio Box Shadow', 'herrington' ),
                                'type'         => \Elementor\Group_Control_Box_Shadow::get_type(),
                                'control_type' => 'group',
