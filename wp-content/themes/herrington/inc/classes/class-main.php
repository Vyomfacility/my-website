...
if (!class_exists('Herrington_Main')) { 
    class Herrington_Main extends Herrington_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Herrington_Main();
            }
...
function herrington() {
    return Herrington_Main::getInstance();
}
// Install
herrington(); 
