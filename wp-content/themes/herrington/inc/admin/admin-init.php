...
/**
 * The Herrington_Admin initiate the theme admin
 */
...
class Herrington_Admin extends Herrington_Base
{
	...
	public function fix_parent_menu()
	{
		...
		$submenu['pxlart'][0][0] = herrington()->get_name() . ' ' . esc_html__('Dashboard', 'herrington');
